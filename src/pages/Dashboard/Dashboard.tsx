...
import UsersList from "../../components/UserLists/UserLists";
...
function DashBoard() {
  const [selectedChat, setSelectedChat] = useState<CometChat.User | any>();

  const handleChatSelect = (chat: CometChat.User) => {
  ...
  return (
    <div className="container">
      <div className="container1">
        <UsersList selectChat={handleChatSelect} />
      </div>
      <div className="container2">
        <Navbar
          user={selectedChat}
          avatar={selectedChat?.user?.avatar || USER_PLACE_HOLDER}
        />
        <div></div>
      </div>
    </div>
