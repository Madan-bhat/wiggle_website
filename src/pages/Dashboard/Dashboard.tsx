      ...
      <div className="userListContainer">
        ...
        <div className="userCardContainer">
          {users?.map((item: any, index) => (
            <div onClick={() => handleChatSelect(item)} className="user">
              <div className="cardContainer">
                <img
                  className="image"
                  src={item?.avatar || USER_PLACE_HOLDER}
                />
